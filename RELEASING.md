1. Update version to, e.g. 1.0.0 in ``altair_saver/__init__.py``
...
7. update version to, e.g. 1.1.0.dev0 in ``altair_saver/__init__.py``
...
10. Publish release on github, copying changelog entry.
